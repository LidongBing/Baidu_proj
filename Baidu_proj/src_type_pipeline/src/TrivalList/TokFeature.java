...
/*
 * This is a duplication of the ClassifyExample.TokFeature.java
...
public class TokFeature {
	...
	public static void printHelp() {
		...
		System.out
				.println("Please give five args: tokFeatFile, doFilter, labelMapFile, inputExmpFile, and outputFeatureFile.");
		...
		System.out
				.println("inputExmpFile: contains the label ID map, in format 'symptom\t id'");
		System.out.println("outputFeatureFile: the output file");
		System.out
				.println("If input example file is a testing file, it may or may not have labels");
		System.exit(0);
