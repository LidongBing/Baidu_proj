...
public class CrossValiSplitter {
	...
	public static void main(String[] args) throws IOException {
		...
		// ArrayList<String> labels = new ArrayList<String>();
		// HashMap<String, ArrayList<String>> exampleMap = new HashMap<String,
		// ArrayList<String>>();
		//
		// int no = 10000;
		// loadLabelAndExamples("svmData\\listExample" + no, labels,
		// exampleMap);
		// splitExamplesIntoSubFiles("svmData\\n_fold\\listExample" + no
		// + ".trainPart", "svmData\\n_fold\\listExample" + no
		// + ".testPart", labels, exampleMap, 10);
