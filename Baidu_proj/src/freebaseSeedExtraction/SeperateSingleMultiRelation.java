...
public class SeperateSingleMultiRelation {
	/*
	 * args[0] aggregate seed file 
	 * args[1] single seed file 
	 * args[2] multi seed file
	...
	public static void main(String[] args) throws IOException {
		...
		br.close();
		BufferedWriter bw1 = new BufferedWriter(new FileWriter(basePath+args[1]));
		BufferedWriter bw2 = new BufferedWriter(new FileWriter(basePath+args[2]));
